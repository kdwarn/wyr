...
one_author_last_name = ["Smith", "Smith;", "Smith, ", "; Smith , ; "]

one_author_first_name = [", Jane;", ", Jane ", "; , Jane ; "]
...
def test_one_author(one_author):
    ...
    assert (
        len(authors) == 1
        and authors[0]["first_name"] == "Jane"
        and authors[0]["last_name"] == "Smith"
    )
...
def test_one_author_last_name_only(one_author_last_name):
    ...
    assert (
        len(authors) == 1 and authors[0]["last_name"] == "Smith" and authors[0]["first_name"] == ""
    )
...
def test_one_author_first_name_only(one_author_first_name):
    ...
    assert (
        len(authors) == 1 and authors[0]["last_name"] == "" and authors[0]["first_name"] == "Jane"
    )
...
def test_three_authors(three_authors):
    ...
    assert (
        ...
        and authors[0]["last_name"] == "Smith"
        and authors[0]["first_name"] == "Jane"
        and authors[1]["last_name"] == "Rodriguez"
        and authors[1]["first_name"] == "Jose"
        and authors[2]["last_name"] == "Johnson"
        and authors[2]["first_name"] == "Bill"
    )
...
def test_add4(flask_client, user4):
    ...
    content = {"title": "Test", "link": "http://whatyouveread.com/1"}
...
def test_edit3(flask_client, user4):
    ...
    content = {"id": "1", "title": "Test", "link": "http://whatyouveread.com/2"}
